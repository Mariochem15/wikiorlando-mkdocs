Life is an unpredictable journey filled with various challenges. If you're facing hardships, these resources bellow are here to help you during these difficult times. Here, you can find shelters, food aid, healthcare, and other essential resources. Remember, you're not alone and will come out stronger on the other side.   
...
??? note "Contact Information"
    ...
    === "Women & Children Shelter"
        ...
        [**Website**](https://orlando.salvationarmyflorida.org/)  
...
??? note "Contact Information"
    ...
    [**Website**](https://www.fporlandofl.org/)  
...
??? note "Contact Information"
    ...
    [**Website**](https://www.covenanthousefl.org/orlando)  
...
??? note "Contact Information"
    ...
    [**Website**](https://www.djj.state.fl.us/programs-facilities/prevention-programs/orange-county-youth-shelter)  

    **Phone number:**  
    407-836-7676

    **Address:**  
    1800 East Michigan Street   
    Orlando, FL 32806
...
??? note "Contact Information"
    ...
    [**Website**](https://www.christianhelp.org/grocery-services)  

    **Phone number:**  
    407-834-4022

    **Email:**  
    info@christianhelp.org
...
??? note "Contact Information"
    ...
    === "Downtown Orlando Location"
        ...
        [**Website**](https://www.christianservicecenter.org/)  
...
1.  Distributions typically occur on the fourth Saturday of the month; see the website below for the exact dates.

??? note "Contact Information"

    [**Website**](https://poporlando.com/event/food-pantry-distribution-2-3/2026-04-25/)  
    ...
    **Hours:**  
    (1) 8:30 AM to 10:30 PM
    { .annotate }

    1.  Distributions typically occur on the fourth Saturday of the month; see the website for the exact dates.
...
??? note "Contact Information"
    ...
    [**Website**](https://svdporlando.org/)  

    **Phone number:**  
    407-886-0940 

    **Address:**  
    770 Orange Blossom Trail    
...
??? note "Contact Information"
    ...
    [**Website**](https://floridaliheap.com/relief_program)  
